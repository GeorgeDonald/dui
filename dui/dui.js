...
function duiFunc(window, noGlobal) {
    ...
    function registerEventListeners(wnd){
        var events = {
            abort: {handler: 'on_abort', spec: `The event occurs when the loading of a media is aborted`, events: `UiEvent, Event`},
            afterprint: {handler: 'on_afterprint', spec: `The event occurs when a page has started printing, or if the print dialogue box has been closed`, events: `Event`},
            animationend: {handler: 'on_animationend', spec: `The event occurs when a CSS animation has completed`, events: `AnimationEvent`},
            animationiteration: {handler: 'on_animationiteration', spec: `The event occurs when a CSS animation is repeated`, events: `AnimationEvent`},
            animationstart: {handler: 'on_animationstart', spec: `The event occurs when a CSS animation has started`, events: `AnimationEvent`},
            beforeprint: {handler: 'on_beforeprint', spec: `The event occurs when a page is about to be printed`, events: `Event`},
            beforeunload: {handler: 'on_beforeunload', spec: `The event occurs before the document is about to be unloaded`, events: `UiEvent, Event`},
            blur: {handler: 'on_blur', spec: `The event occurs when an element loses focus`, events: `FocusEvent`},
            canplay: {handler: 'on_canplay', spec: `The event occurs when the browser can start playing the media (when it has buffered enough to begin)`, events: `Event`},
            canplaythrough: {handler: 'on_canplaythrough', spec: `The event occurs when the browser can play through the media without stopping for buffering`, events: `Event`},
            change: {handler: 'on_change', spec: `The event occurs when the content of a form element, the selection, or the checked state have changed (for <input>, <select>, and <textarea>)`, events: `Event`},
            click: {handler: 'on_click', spec: `The event occurs when the user clicks on an element`, events: `MouseEvent`},
            ...
            copy: {handler: 'on_copy', spec: `The event occurs when the user copies the content of an element`, events: `ClipboardEvent`},
            cut: {handler: 'on_cut', spec: `The event occurs when the user cuts the content of an element`, events: `ClipboardEvent`},
            dblclick: {handler: 'on_dblclick', spec: `The event occurs when the user double-clicks on an element`, events: `MouseEvent`},
            drag: {handler: 'on_drag', spec: `The event occurs when an element is being dragged`, events: `DragEvent`},
            dragend: {handler: 'on_dragend', spec: `The event occurs when the user has finished dragging an element`, events: `DragEvent`},
            dragenter: {handler: 'on_dragenter', spec: `The event occurs when the dragged element enters the drop target`, events: `DragEvent`},
            dragleave: {handler: 'on_dragleave', spec: `The event occurs when the dragged element leaves the drop target`, events: `DragEvent`},
            dragover: {handler: 'on_dragover', spec: `The event occurs when the dragged element is over the drop target`, events: `DragEvent`},
            dragstart: {handler: 'on_dragstart', spec: `The event occurs when the user starts to drag an element`, events: `DragEvent`},
            drop: {handler: 'on_drop', spec: `The event occurs when the dragged element is dropped on the drop target`, events: `DragEvent`},
            durationchange: {handler: 'on_durationchange', spec: `The event occurs when the duration of the media is changed`, events: `Event`},
            ended: {handler: 'on_ended', spec: `The event occurs when the media has reach the end (useful for messages like "thanks for listening")`, events: `Event`},
            error: {handler: 'on_error', spec: `The event occurs when an error occurs while loading an external file`, events: `ProgressEvent, UiEvent, Event`},
            focus: {handler: 'on_focus', spec: `The event occurs when an element gets focus`, events: `FocusEvent`},
            focusin: {handler: 'on_focusin', spec: `The event occurs when an element is about to get focus`, events: `FocusEvent`},
            focusout: {handler: 'on_focusout', spec: `The event occurs when an element is about to lose focus`, events: `FocusEvent`},
            fullscreenchange: {handler: 'on_fullscreenchange', spec: `The event occurs when an element is displayed in fullscreen mode`, events: `Event`},
            fullscreenerror: {handler: 'on_fullscreenerror', spec: `The event occurs when an element can not be displayed in fullscreen mode`, events: `Event`},
            hashchange: {handler: 'on_hashchange', spec: `The event occurs when there has been changes to the anchor part of a URL`, events: `HashChangeEvent`},
            input: {handler: 'on_input', spec: `The event occurs when an element gets user input`, events: `InputEvent, Event`},
            invalid: {handler: 'on_invalid', spec: `The event occurs when an element is invalid`, events: `Event`},
            keydown: {handler: 'on_keydown', spec: `The event occurs when the user is pressing a key`, events: `KeyboardEvent`},
            keypress: {handler: 'on_keypress', spec: `The event occurs when the user presses a key`, events: `KeyboardEvent`},
            keyup: {handler: 'on_keyup', spec: `The event occurs when the user releases a key`, events: `KeyboardEvent`},
            //load: {handler: 'on_load', spec: `The event occurs when an object has loaded`, events: `UiEvent, Event`},
            loadeddata: {handler: 'on_loadeddata', spec: `The event occurs when media data is loaded`, events: `Event`},
            loadedmetadata: {handler: 'on_loadedmetadata', spec: `The event occurs when meta data (like dimensions and duration) are loaded`, events: `Event`},
            loadstart: {handler: 'on_loadstart', spec: `The event occurs when the browser starts looking for the specified media`, events: `ProgressEvent`},
            message: {handler: 'on_message', spec: `The event occurs when a message is received through the event source`, events: `Event`},
            mousedown: {handler: 'on_mousedown', spec: `The event occurs when the user presses a mouse button over an element`, events: `MouseEvent`},
            mouseenter: {handler: 'on_mouseenter', spec: `The event occurs when the pointer is moved onto an element`, events: `MouseEvent`},
            mouseleave: {handler: 'on_mouseleave', spec: `The event occurs when the pointer is moved out of an element`, events: `MouseEvent`},
            mousemove: {handler: 'on_mousemove', spec: `The event occurs when the pointer is moving while it is over an element`, events: `MouseEvent`},
            mouseover: {handler: 'on_mouseover', spec: `The event occurs when the pointer is moved onto an element, or onto one of its children`, events: `MouseEvent`},
            mouseout: {handler: 'on_mouseout', spec: `The event occurs when a user moves the mouse pointer out of an element, or out of one of its children`, events: `MouseEvent`},
            mouseup: {handler: 'on_mouseup', spec: `The event occurs when a user releases a mouse button over an element`, events: `MouseEvent`},
            mousewheel: {handler: 'on_mousewheel', spec: `Deprecated. Use the wheel event instead`, events: `WheelEvent`},
            ...
            paste: {handler: 'on_paste', spec: `The event occurs when the user pastes some content in an element`, events: `ClipboardEvent`},
            pause: {handler: 'on_pause', spec: `The event occurs when the media is paused either by the user or programmatically`, events: `Event`},
            play: {handler: 'on_play', spec: `The event occurs when the media has been started or is no longer paused`, events: `Event`},
            playing: {handler: 'on_playing', spec: `The event occurs when the media is playing after having been paused or stopped for buffering`, events: `Event`},
            popstate: {handler: 'on_popstate', spec: `The event occurs when the window's history changes`, events: `PopStateEvent`},
            progress: {handler: 'on_progress', spec: `The event occurs when the browser is in the process of getting the media data (downloading the media)`, events: `Event`},
            ratechange: {handler: 'on_ratechange', spec: `The event occurs when the playing speed of the media is changed`, events: `Event`},
            //resize: {handler: 'on_resize', spec: `The event occurs when the document view is resized`, events: `UiEvent, Event`},
            reset: {handler: 'on_reset', spec: `The event occurs when a form is reset`, events: `Event`},
            scroll: {handler: 'on_scroll', spec: `The event occurs when an element's scrollbar is being scrolled`, events: `UiEvent, Event`},
            search: {handler: 'on_search', spec: `The event occurs when the user writes something in a search field (for <input="search">)`, events: `Event`},
            seeked: {handler: 'on_seeked', spec: `The event occurs when the user is finished moving/skipping to a new position in the media`, events: `Event`},
            seeking: {handler: 'on_seeking', spec: `The event occurs when the user starts moving/skipping to a new position in the media`, events: `Event`},
            select: {handler: 'on_select', spec: `The event occurs after the user selects some text (for <input> and <textarea>)`, events: `UiEvent, Event`},
            show: {handler: 'on_show', spec: `The event occurs when a <menu> element is shown as a context menu`, events: `Event`},
            ...
            storage: {handler: 'on_storage', spec: `The event occurs when a Web Storage area is updated`, events: `StorageEvent`},
            submit: {handler: 'on_submit', spec: `The event occurs when a form is submitted`, events: `Event`},
            suspend: {handler: 'on_suspend', spec: `The event occurs when the browser is intentionally not getting media data`, events: `Event`},
            timeupdate: {handler: 'on_timeupdate', spec: `The event occurs when the playing position has changed (like when the user fast forwards to a different point in the media)`, events: `Event`},
            toggle: {handler: 'on_toggle', spec: `The event occurs when the user opens or closes the <details> element`, events: `Event`},
            touchcancel: {handler: 'on_touchcancel', spec: `The event occurs when the touch is interrupted`, events: `TouchEvent`},
            touchend: {handler: 'on_touchend', spec: `The event occurs when a finger is removed from a touch screen`, events: `TouchEvent`},
            touchmove: {handler: 'on_touchmove', spec: `The event occurs when a finger is dragged across the screen`, events: `TouchEvent`},
            touchstart: {handler: 'on_touchstart', spec: `The event occurs when a finger is placed on a touch screen`, events: `TouchEvent`},
            transitionend: {handler: 'on_transitionend', spec: `The event occurs when a CSS transition has completed`, events: `TransitionEvent`},
            //unload: {handler: 'on_unload', spec: `The event occurs once a page has unloaded (for <body>)`, events: `UiEvent, Event`},
            volumechange: {handler: 'on_volumechange', spec: `The event occurs when the volume of the media has changed (includes setting the volume to "mute")`, events: `Event`},
            waiting: {handler: 'on_waiting', spec: `The event occurs when the media has paused but is expected to resume (like when the media pauses to buffer more data)`, events: `Event`},
            wheel: {handler: 'on_wheel', spec: `The event occurs when the mouse wheel rolls up or down over an element`, events: `WheelEvent`},
        }
